...
class _module_function(torch.autograd.Function):
	...
	@staticmethod
	def get_ctx():
		return _module_function.ctx.native_ctx
...
class Module(torch.nn.Module):
	...
	def forward(self, x):
		...
		self.ctx = _module_function.get_ctx()
...
class Encoding(Module):
	...
	# def cal_dy(self,loss):
	# 	# input, params, doutput = ctx.saved_tensors
	# 	# dy = ctx.native_tcnn_module.cal_dy(params,loss)
	# 	dy = self.native_tcnn_module.cal_dy(self.ctx,loss)
	# 	return dy